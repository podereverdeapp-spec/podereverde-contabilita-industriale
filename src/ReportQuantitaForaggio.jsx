...
export default function ReportQuantitaForaggio() {
  ...
  async function calcola() {
    ...
    setRighe(null);
    try {
      const dati = await calcolaDatiForaggioAnno(anno);
      setRighe(dati.righe);
  ...
  function esporta() {
    ...
    esportaExcel(`ReportForaggio_${anno}`, [
      { nome: "Report Foraggio", righe: righeExcel },
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
        <h1 style={{ color: C.primary, fontSize: 24, marginBottom: 4 }}>Report Quantità — Foraggio</h1>
