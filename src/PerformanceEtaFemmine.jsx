...
export default function PerformanceEtaFemmine({ onNavigate }) {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1300, margin: "0 auto" }}>
      ...
      <h1 style={{ color: C.primary, fontSize: 24, marginBottom: 4 }}>Performance per Fascia d'Età — ♀️ Solo Femmine</h1>
      <p style={{ color: C.muted, marginTop: 0, marginBottom: 16 }}>
        Curva di Gompertz adattata solo sugli animali femmine — una delle due curve che compongono la media ponderata mostrata nella pagina principale.
      </p>
